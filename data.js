export const questionsCars =[
    ...
    /// 2
    {
        ...
        reponse: [
            ...
            { text: "Indique une fin d’obligation.", correct: false },
            { text: " Indique une obligation.", correct: false },
        ],
    },
    /// 3
    {
        ...
        reponse: [
            ...
            { text: "Marquer un arrêt obligatoire.", correct: true },
            { text: "Accélérer pour éviter un accident.", correct: false },
        ],
    },
    /// 4
    {
        ...
        reponse: [
            ...
            { text: "À tout moment la nuit.", correct: false },
            { text: "Lorsque la visibilité est de 300 mètres.", correct: false },
        ],
    },
    /// 5
    {
        ...
        reponse: [
            ...
            { text: "Elle sert uniquement de décoration.", correct: false },
            { text: "Elle permet de stationner sur le bas-côté.", correct: false },
        ],
    },
    /// 6
    {
        ...
        reponse: [
            ...
            { text: "S’arrêter et lui céder le passage.", correct: true },
            { text: "Le contourner rapidement.", correct: false },
        ],
    },
    /// 7
    {
        ...
        reponse: [
            ...
            { text: "Vous avez la priorité.", correct: false },
            { text: "Vous devez klaxonner.", correct: false },
        ],
    },
    /// 8
    {
    ...
    /// 9
    {
        ...
        reponse: [
            ...
            { text: "Aux véhicules rapides.", correct: false },
            { text: " Aux véhicules prioritaires uniquement.", correct: false },
        ],
    },
    /// 10
    {
        ...
        reponse: [
            ...
            { text: "Vérifier dans les rétroviseurs, signaler avec le clignotant et contrôler les angles morts.", correct: true },
            { text: "Accélérer pour éviter les autres véhicules.", correct: false },
        ],
    },
    /// 11
    {
        ...
        reponse:[
            ...
            {text: "Les conditions météorologiques.", correct: false},
            {text: "Les infractions aux limitations de vitesse.", correct: false},
        ]
    },
    /// 12
    {
        ...
        reponse: [
            ...
            { text: "Fin d’interdiction de tourner.", correct: false },
    ...
    /// 14
    {
        ...
        reponse: [
            ...
            { text: "1 g/L de sang.", correct: false },
        ],
    },
    /// 15
    {
        ...
        reponse: [
            ...
            { text: "Regarder le bas-côté droit pour éviter l’éblouissement.", correct: true },
            { text: "Ralentir et klaxonner.", correct: false },
        ],
    },
    /// 16
    {
        ...
        reponse: [
            ...
            { text: "Passer le plus près possible pour ne pas gêner la circulation.", correct: false },
            { text: "Doubler sans précaution particulière.", correct: false },
        ],
    },
    /// 17
    {
        ...
        reponse: [
            ...
            { text: "Reprendre la route sans intervenir.", correct: false },
            { text: "Déplacer les blessés.", correct: false },
        ],
    },
    /// 18
    {
        ...
        reponse: [
            ...
            { text: "100 mètres.", correct: false },
            { text: "200 mètres.", correct: true },
            { text: "500 mètres.", correct: false },
        ],
    },
    /// 19
    {
        ...
        reponse: [
            ...
            { text: "Dès que la visibilité est insuffisante.", correct: true },
            { text: "Jamais, les feux de position suffisent.", correct: false },
        ],
    },
    /// 20
    {
        ...
        reponse: [
            ...
            { text: "Relâcher l’accélérateur et tenir fermement le volant.", correct: true },
            { text: "Accélérer pour traverser la flaque plus vite.", correct: false },
        ],
    },
    /// 21
    {
    ...
    /// 22
    {
        ...
        reponse: [
            ...
            { text: "La carte bancaire", correct: false },
    ...
    /// 23
    {
        ...
        reponse: [
            ...
            { text: "Céder le passage aux véhicules venant de droite", correct: false },
            { text: "S'arrêter systématiquement", correct: false }
        ]
    },
    /// 24
    {
        ...
        reponse: [
            ...
            { text: "2 secondes de distance de sécurité", correct: true },
            { text: "50 mètres", correct: false }
        ]
    },
    /// 25
    {
        ...
        reponse: [
            ...
            { text: "Elle est réduite à 110 km/h", correct: true },
            { text: "Il est interdit de rouler", correct: false }
        ]
    },
    /// 26
    {
        ...
        reponse: [
            ...
            { text: "Obligation de tourner à gauche", correct: true },
            { text: "Sens interdit", correct: false }
        ]
    },
    /// 27
    {
        ...
        reponse: [
            ...
            { text: "Par temps de pluie ou de brouillard", correct: true },
            { text: "Seulement en hiver", correct: false }
        ]
    },
    /// 28
    {
        ...
        reponse: [
            ...
            { text: "S’arrêter sauf si cela est dangereux", correct: true },
            { text: "Ignorer le feu", correct: false }
        ]
    },
    /// 29
    {
        ...
        reponse: [
            ...
            { text: "Interdit même avec un kit mains libres", correct: true },
            { text: "Autorisé uniquement en conduisant à faible vitesse", correct: false }
        ]
    },
    /// 30
    {
        ...
        reponse: [
            ...
            { text: "En mettant votre clignotant gauche", correct: true },
            { text: "En mettant votre clignotant droit", correct: false }
        ]
    },
    /// 31
    {
    ...
    /// 32
    {
        ...
        reponse: [
            ...
            { text: "Vous arrêter pour lui laisser le passage", correct: true },
            { text: "Contourner le piéton rapidement", correct: false }
        ]
    },
    /// 33
    {
        ...
        reponse: [
            ...
            { text: "Un danger", correct: true },
            { text: "Une indication", correct: false }
        ]
    },
    /// 34
    {
        ...
        reponse: [
            ...
            { text: "Lorsque la visibilité est insuffisante", correct: true },
            { text: "Si vous roulez à plus de 50 km/h", correct: false }
        ]
    },
    /// 35
    {
        ...
        reponse: [
            ...
            { text: "Aucune sanction", correct: false }
        ]
    },
    /// 36
    {
        ...
        reponse: [
            ...
            { text: "Un accident frontal", correct: true },
            { text: "Une surconsommation de carburant", correct: false }
        ]
    },
    /// 37
    {
        ...
        reponse: [
            ...
            { text: "Servir uniquement en cas de panne ou d'urgence", correct: true },
            { text: "Stationner temporairement", correct: false }
        ]
    },
    /// 38
    {
        ...
        reponse: [
            ...
            { text: "Réduire votre vitesse et augmenter les distances de sécurité", correct: true },
            { text: "Utiliser uniquement les feux de position", correct: false }
        ]
    },
    /// 39
    {
        ...
        reponse: [
            ...
            { text: "Se mettre en sécurité derrière la glissière et appeler les secours", correct: true },
            { text: "Allumer les feux de route", correct: false }
        ]
    },
    /// 40
    {
        ...
        reponse: [
            ...
            { text: "Passer en feux de croisement pour éviter d’éblouir", correct: true },
            { text: "Fermer les yeux quelques secondes", correct: false }
        ]
    }
];
...
export const questionsMotorBike =[
    {
        ...
        reponse: [
            ...
            { text: "Un gilet fluorescent", correct: false },
            { text: "Des bottes de moto", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Le bruit du moteur", correct: false },
            { text: "Un manque d’assurance", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Il protège mieux contre le vent", correct: false },
            { text: "Il réduit le champ de vision", correct: false }
        ]
    },
    {
        ...
        reponse: [
            { text: "10 mètres", correct: false },
            { text: "2 secondes de distance", correct: true },
            { text: "30 mètres", correct: false },
            { text: "Une longueur de moto", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Un pantalon renforcé", correct: false },
            { text: "Un blouson avec dorsale", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Relâcher doucement les commandes et garder le cap", correct: true },
            { text: "Tourner le guidon rapidement", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "En permanence, de jour comme de nuit", correct: true },
            { text: "Seulement en cas de brouillard", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Pour éviter un blocage des roues et garder le contrôle", correct: true },
            { text: "Pour user les freins plus rapidement", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Ralentir avant d’entrer et accélérer progressivement à la sortie", correct: true },
            { text: "Rester au milieu de la voie", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Relâcher doucement l’accélérateur et stabiliser la moto", correct: true },
            { text: "Freiner brutalement de l’avant", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Freiner pour faciliter le dépassement", correct: false },
            { text: "Se déporter à gauche pour éviter la collision", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Surchauffer les pneus", correct: false },
            { text: "Ralentir trop rapidement", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Pour augmenter la vitesse de la moto", correct: false },
            { text: "Pour réduire la consommation de carburant", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Ralentir légèrement et maintenir une distance de sécurité suffisante", correct: true },
            { text: "Changer brusquement de voie pour le laisser passer", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "De jour et en cas de soleil", correct: false },
    ...
    },
    {
        ...
        reponse: [
            ...
            { text: "En ralentissant et en évitant les accélérations brutales", correct: true },
            { text: "En freinant sans relâcher les commandes", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Pour réduire les risques de blessure en cas de chute", correct: true },
            { text: "Pour augmenter la visibilité", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Freiner progressivement tout en entrant dans le virage", correct: false },
            { text: "Tourner brusquement pour réduire l'angle du virage", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Pour garder une vitesse constante", correct: false },
            { text: "Pour éviter d'avoir mal au dos", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Ralentir, mais ne pas marquer d'arrêt", correct: false },
            { text: "Contourner les autres véhicules", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Une meilleure circulation sur la route", correct: false },
            { text: "Un gain de vitesse", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Une combinaison légère", correct: false },
    ...
    },
    {
        ...
        reponse: [
            ...
            { text: "Ralentir à vitesse très faible", correct: false },
            { text: "Utiliser la bande d'arrêt d'urgence", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Contaminer moins que les autres véhicules", correct: false },
            { text: "Utiliser la voie publique comme une voie rapide", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Freiner uniquement avec la roue arrière", correct: false },
            { text: "Augmenter la vitesse pour réduire l'impact de la friction", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Rouler plus vite pour ne pas se mouiller", correct: false },
            { text: "Changer de moto", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Elle diminue le risque de chute", correct: false },
            { text: "Elle permet de rouler plus vite", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Une perte de contrôle du moteur", correct: false },
    ...
    },
    {
        ...
        reponse: [
            ...
            { text: "Parce qu'il est nécessaire de faire plus de manœuvres", correct: false },
            { text: "Parce que la moto est plus rapide", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "S'arrêter dans un endroit sécurisé et vous reposer", correct: true },
            { text: "Rouler plus lentement", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "L'état général et le contrôle technique", correct: true },
            { text: "Le type de phare utilisé", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Freiner brusquement avant chaque virage", correct: false },
            { text: "Rester au milieu de la voie en permanence", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Tourner brutalement le guidon", correct: false },
            { text: "Chasser les autres véhicules pour dégager la route", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Le moteur surchauffe", correct: false },
            { text: "Les pneus deviennent plus adhérents", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Pour réduire l'usure des pneus", correct: false },
            { text: "Pour être vu par les autres conducteurs", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Avant de commencer à tourner", correct: true },
            { text: "Seulement lorsque vous êtes déjà dans le virage", correct: false }
        ]
    },
    {
        ...
        reponse: [
            { text: "Une amende et un retrait de points", correct: true },
            { text: "Une perte de vitesse", correct: false },
            { text: "Une baisse de consommation de carburant", correct: false },
    ...
    },
    {
        ...
        reponse: [
            ...
            { text: "Une conduite plus confortable", correct: false },
    ...
    },
    {
        ...
        reponse: [
            ...
            { text: "La laisser sur le bas-côté et continuer à rouler", correct: false },
            { text: "L’arrêter en plein milieu de la voie pour attirer l'attention", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Ralentir et contourner l’obstacle avec précaution", correct: true },
            { text: "Augmenter la vitesse pour le surmonter rapidement", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Rendre la moto plus aérodynamique", correct: false }
        ]
    }
]
;
export const questionsBoat =[
    {
        ...
        reponse: [
            ...
            { text: "12 nœuds", correct: true },
            { text: "15 nœuds", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Le bateau est en train de pêcher", correct: false },
            { text: "Le bateau transporte des marchandises dangereuses", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "En utilisant un feu rouge", correct: true },
            { text: "En signalant le virage avec une lumière blanche", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Augmenter la vitesse pour mieux être vu", correct: false },
            { text: "Changer de cap sans prévenir l'autre bateau", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Le bateau est en excursion touristique", correct: false },
            { text: "Le bateau est en état de détresse", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Le manque de visibilité de la plage", correct: false },
            { text: "L'impossibilité de manœuvrer", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Changer immédiatement de cap", correct: false },
            { text: "Aucun besoin d'agir", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Une zone où les plaisanciers sont autorisés à naviguer librement", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Avertir le bateau en émettant un signal sonore", correct: true },
            { text: "Tourner à gauche pour l'éviter", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Lors de la navigation en zone dégagée", correct: false },
            { text: "Lors de l'entrée dans un port", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Le bateau est libre de toute manœuvre et en sécurité", correct: true },
            { text: "Le bateau est en train de se réparer", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "S'arrêter et signaler l'incident aux autorités compétentes", correct: true },
            { text: "Accélérer pour traverser la zone rapidement", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Pour maintenir la tête hors de l'eau en cas de chute", correct: true },
            { text: "Pour rendre la navigation plus confortable", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Pour réduire la pollution", correct: false },
            { text: "Pour faire la course", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "La couleur de la coque", correct: false },
            { text: "La présence de passagers", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Le bateau est un bateau-pêche", correct: false },
            { text: "Le bateau est en train de se réapprovisionner", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "En faisant un signe avec les bras", correct: false },
            { text: "En changeant de cap de manière visible", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Rapprocher du rivage pour observer les baigneurs", correct: false },
            { text: "Nager à côté du bateau pour les surveiller", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Une zone de baignade", correct: false },
            { text: "Une zone de passage interdit", correct: true },
            { text: "Un point d'ancrage", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Changer de cap sans prévenir", correct: false },
            { text: "Conduire avec les feux allumés mais sans réduire la vitesse", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Modifier brusquement votre cap sans signaler", correct: true },
            { text: "Accélérer rapidement", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Fuir en ligne droite", correct: false },
            { text: "Attendre que la tempête passe sans bouger", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Accélérer pour prendre de l'avance", correct: false },
            { text: "Essayer de le doubler", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Elle marque le côté droit d'un chenal", correct: true },
            { text: "Elle est utilisée pour signaler un port", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Accélérer pour aller plus loin", correct: false },
            { text: "Attendre que la visibilité s'améliore avant de naviguer", correct: false }
        ]
    },
    {
        question: "Que signifie un pavillon jaune sur un bateau ?",
        ...
        reponse: [
            { text: "Le bateau est en quarantaine", correct: true },
            { text: "Le bateau est en danger", correct: false },
            { text: "Le bateau est un navire militaire", correct: false },
            { text: "Le bateau indique un départ imminent", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Changer de cap pour l'éviter", correct: false },
            { text: "Continuer comme si de rien n'était", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Lorsqu'il y a un danger ou une réduction de visibilité", correct: true },
            { text: "Lorsque le bateau change de direction", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Changer de cap pour l'éviter", correct: false },
            { text: "Rester sur place pour ne pas gêner", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Indiquer le passage sûr pour naviguer", correct: true },
            { text: "Indiquer une zone de pêche", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Les bateaux plus gros ont la priorité", correct: false },
            { text: "Les bateaux qui viennent de l'est ont priorité", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Le type de bateau", correct: false },
            { text: "Le nom du capitaine", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Continuer à naviguer à pleine vitesse", correct: false },
            { text: "Ne pas réagir et attendre", correct: false },
            { text: "Essayer de réparer seul sans prévenir", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Informer les autres bateaux de l'état du moteur", correct: false },
            { text: "Informer sur la taille du bateau", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Le bateau est en mouvement à grande vitesse", correct: false },
            { text: "Le bateau est en état de détresse", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Elle signale un port", correct: false },
            { text: "Elle indique un danger", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Changer de cap pour l'éviter", correct: false },
            { text: "Accélérer pour éviter une collision", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Naviguer à vitesse normale et ne pas prêter attention", correct: false },
            { text: "Changer de cap pour éviter toute zone de pêche", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Manœuvrer immédiatement", correct: false },
            { text: "Ne rien faire et continuer de naviguer", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Continuer à la même vitesse", correct: false },
            { text: "Changer de cap pour éviter le port", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Le bateau signale une urgence médicale", correct: false },
    ...
    },
    {
        ...
        reponse: [
            ...
            { text: "Point de mouillage autorisé", correct: true },
            { text: "Port de pêche", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Allumer les feux de navigation", correct: false },
    ...
    },
    {
        ...
        reponse: [
            ...
            { text: "Ne rien faire, la visibilité s'améliorera", correct: false },
            { text: "Naviguer sans lumière", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Changer de cap sans ralentir", correct: false },
            { text: "Rester en ligne droite", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Signaler un danger", correct: false },
            { text: "Délimiter la zone de pêche", correct: false }
        ]
    },
    {
    ...
    },
    {
        ...
        reponse: [
            ...
            { text: "Ralentir et approcher de la bouée", correct: false },
            { text: "Tourner autour de la bouée", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Ralentir sans prendre de précautions", correct: false },
            { text: "S'arrêter pour observer", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Le bateau a un problème mécanique", correct: false },
            { text: "Le bateau signale un danger", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Accélérer pour ne pas le bloquer", correct: false },
            { text: "Changer de cap immédiatement", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Utiliser un autre objet comme ancre", correct: false },
            { text: "Rester sur place sans rien faire", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Les bateaux de plus grande taille ont priorité", correct: false },
            { text: "Il n'y a pas de priorité", correct: false }
        ]
    },
    {
        ...
        reponse: [
            ...
            { text: "Lorsque vous êtes au port", correct: false },
